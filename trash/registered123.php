...
<label>Email:      </label><input     type="text"         id="emailid"           name="emailid"  placeholder="last name" required></input><br><br>
<label>password:   </label><input     type="text"         id="password"               name="password"   placeholder="Your Username"></input><br><br>
